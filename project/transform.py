from project import DATASET_DIR, ROAD_ACCIDENTS_DIR, TRANSFORMED_ROAD_ACCIDENT_DATASET_FILE
...
if __name__ == '__main__':
    ...
    transformed_dataset_path = os.path.join(DATASET_DIR, ROAD_ACCIDENTS_DIR, TRANSFORMED_ROAD_ACCIDENT_DATASET_FILE)
